...
struct EditProfileView: View {
    ...
    @State var imagenPerfil: Image? = Image("ejemploFoto")
    ...
    var body: some View{
        ...
        VStack(alignment: .leading){
            ...
            ZStack(alignment: .leading){
                ...
                TextField("", text: $correo).foregroundColor(.black)
            }
            
            Divider()
                .frame(height: 1)
                .background(Color(.black)).padding(.bottom)
            
            
            Text("Contraseña").foregroundColor(.brown)
            ...
            ZStack(alignment: .leading){
                ...
                SecureField("", text: $contraseña).foregroundColor(.black)
            ...
            Text("Nombre").foregroundColor(.brown)
            ...
            ZStack(alignment: .leading){
                ...
                TextField("", text: $nombre).foregroundColor(.black)
            ...
            Divider()
                .frame(height: 1)
                .background(Color(.black)).padding(.bottom,32)
            ...
            Button(action:{ actualizarDatos()}) {
                Text("Actualizar Datos")
                    ...
                    .overlay(RoundedRectangle(cornerRadius: 6)
                        .stroke(Color(.white), lineWidth: 3).shadow(color: .white, radius: 6))
            }.padding(.bottom)
